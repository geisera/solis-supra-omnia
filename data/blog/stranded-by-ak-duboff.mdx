...
- **Cliffhanger ending, full send**: you'll scream “What?!” and immediately check for book two (_review coming soon_).
- **Classic tropes used _earnestly_**: crash, survival, secret tech played straight, not subverted (_I loved this_).
