...
Rick Partlow’s *Archangel* kicks off the **Drop Trooper: Archangel** series with a rocket-assisted
leap into powered armor warfare, black-ops politics, and transhuman morality. Partlow blends the
pace of a modern shooter with themes pulled from Heinlein and Scalzi, military service, cybernetic
identity, and the price of obedience ([amazon][1]).
...
[1]: https://amzn.to/4kRpmNJ 'Archangel (Drop Trooper: Archangel Book 1) by Rick Partlow'
